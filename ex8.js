...
const genderGames = videogames.filter((game)=> game.genders.includes('RPG'));

const score = genderGames.reduce((acc, game) => acc + game.score,0);

const mediaScore = score/genderGames.length;

console.log("la media de las puntuaciones es: ", mediaScore);